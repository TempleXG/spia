...
public class PopView{
	...
	private boolean outTouchExitable = true;
	...
	public PopView(View anchor){
		...
		window.setTouchInterceptor(new OnTouchListener(){
			...
			public boolean onTouch(View v, MotionEvent event){
				Log.i("Pop","TouchInterceptor " + event.getAction());
				
				if(outTouchExitable && event.getAction() == MotionEvent.ACTION_OUTSIDE){
	...
	protected void preShow(){
		...
		*/
		window.setBackgroundDrawable(new ColorDrawable(0xEEEEEEEE));
